...
public record MatchEvent(
    ...
    public static MatchEvent turnStart(int turnNumber, long timestamp) {
        return new MatchEvent("TURN_START", timestamp, "Turn " + turnNumber + " started", null, null, turnNumber);
    }

    public static MatchEvent hit(String attackerName, String targetName, String actorId, String targetId, int damage,
            long timestamp) {
