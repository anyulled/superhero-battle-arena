...
@Schema(name = "RoundSpec", description = "Specification and constraints for a round")
public record RoundSpecDto(
  ...
  public static RoundSpecDto from(RoundSpec value) {
    return new RoundSpecDto(
        value.description(),
        value.teamSize(),
        value.budgetCap(),
        value.requiredRoles(),
        ...
        value.allowedAlignments());
  }

  public RoundSpec toDomain() {
