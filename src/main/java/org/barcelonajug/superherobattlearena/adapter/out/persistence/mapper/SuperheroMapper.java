...
public interface SuperheroMapper {
  ...
  @Mapping(
      target = "role",
      constant = "Fighter") // Default value in Hero constructor logic, but explicit here is
  // good too
  ...
  Hero.PowerStats toPowerStats(
      org.barcelonajug.superherobattlearena.adapter.out.persistence.entity.SuperheroPowerStatsEntity
          entity);

  @Mapping(source = "heightCm", target = "heightCm")
  @Mapping(source = "weightKg", target = "weightKg")
  Hero.Appearance toAppearance(
      org.barcelonajug.superherobattlearena.adapter.out.persistence.entity.SuperheroAppearanceEntity
          entity);

  Hero.Biography toBiography(
      org.barcelonajug.superherobattlearena.adapter.out.persistence.entity.SuperheroBiographyEntity
          entity);
  ...
  Hero.Images toImages(
      org.barcelonajug.superherobattlearena.adapter.out.persistence.entity.SuperheroImagesEntity
          entity);
}
