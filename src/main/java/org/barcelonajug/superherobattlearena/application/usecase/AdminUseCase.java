...
public class AdminUseCase {
  ...
  public Map<String, Object> runAllBattles(
    ...
    if (sessionIdOrNull != null) {
      ...
      final Optional<Match> anyMatch = matchRepository.findPendingMatches(roundNo, null).stream().findFirst();
    ...
    try {
      ...
      final List<Match> pendingMatches = matchRepository.findPendingMatches(roundNo, sessionId);
