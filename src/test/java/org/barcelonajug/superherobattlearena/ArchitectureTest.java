...
public class ArchitectureTest {
        ...
        // Sub-packages
        private static final String PORT_IN = "org.barcelonajug.superherobattlearena.application.port.in..";
        private static final String PORT_OUT = "org.barcelonajug.superherobattlearena.application.port.out..";
        private static final String ADAPTER_IN_WEB = "org.barcelonajug.superherobattlearena.adapter.in.web..";
        private static final String ADAPTER_OUT_PERSISTENCE = "org.barcelonajug.superherobattlearena.adapter.out.persistence..";

        /**
         * No dependency cycles between top-level slices
         */
        @ArchTest
        static final ArchRule no_cycles_between_top_level_slices = slices()
         ...
         */
        @ArchTest
        static final ArchRule no_entities_in_domain_or_application = noClasses().that()
         ...
         */
        @ArchTest
        static final ArchRule ports_are_interfaces = classes().that().resideInAnyPackage(PORT_IN, PORT_OUT)
                        .should().beInterfaces()
                        .allowEmptyShould(true);
         ...
         */
        @ArchTest
        static final ArchRule controllers_are_only_in_web_adapter = classes().that().areAnnotatedWith(Controller.class)
         ...
         */
        @ArchTest
        static final ArchRule persistence_does_not_depend_on_web_or_input_ports = noClasses().that()
         ...
         */
        @ArchTest
        static final ArchRule entities_are_only_in_persistence_adapter = classes().that().areAnnotatedWith(Entity.class)
         ...
         */
        @ArchTest
        static final ArchRule repositories_are_only_in_persistence_adapter = classes().that()
         ...
         */
        @ArchTest
        static final ArchRule application_does_not_depend_on_adapters_or_config = noClasses().that()
         ...
         */
        @ArchTest
        static final ArchRule domain_is_pure = noClasses().that().resideInAnyPackage(DOMAIN)
                        .should().dependOnClassesThat().resideInAnyPackage(
                                        ADAPTER, APPLICATION, CONFIG, SPRING, SPRING_DATA, JPA)
                        .allowEmptyShould(true);

        @ArchTest
        static final ArchRule domain_should_not_depend_on_application_or_adapter = noClasses()
