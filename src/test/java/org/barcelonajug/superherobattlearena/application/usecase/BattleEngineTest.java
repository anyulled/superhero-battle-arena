...
class BattleEngineTest {
        ...
        void shouldBeDeterministic() {
                ...
                SimulationResult result1 = battleEngine.simulate(matchId, List.of(h1), List.of(h2), seed, teamA, teamB,
                                spec);
                SimulationResult result2 = battleEngine.simulate(matchId, List.of(h1), List.of(h2), seed, teamA, teamB,
                                spec);
                ...
                for (int i = 0; i < result1.events().size(); i++) {
                        assertThat(result1.events().get(i)).usingRecursiveComparison()
        ...
        void fastHeroShouldGoFirst() {
                ...
                SimulationResult result = battleEngine.simulate(matchId, List.of(h1), List.of(h2), 1L, teamA, teamB,
                                spec);
