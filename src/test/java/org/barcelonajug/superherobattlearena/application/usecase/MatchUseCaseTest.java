...
class MatchUseCaseTest {
        ...
        void autoMatch_shouldBeIdempotent_whenCalledMultipleTimes() {
                ...
                ArgumentCaptor<org.barcelonajug.superherobattlearena.domain.Match> matchCaptor = ArgumentCaptor
                                .forClass(org.barcelonajug.superherobattlearena.domain.Match.class);
                verify(matchRepository, times(2)).save(matchCaptor.capture());
                List<org.barcelonajug.superherobattlearena.domain.Match> createdMatches = matchCaptor.getAllValues();
        ...
        void autoMatch_shouldOnlyMatchUnmatchedTeams_whenSomeTeamsAlreadyMatched() {
                ...
                org.barcelonajug.superherobattlearena.domain.Match existingMatch = org.barcelonajug.superherobattlearena.domain.Match
                                .builder()
                ...
                ArgumentCaptor<org.barcelonajug.superherobattlearena.domain.Match> matchCaptor = ArgumentCaptor
                                .forClass(org.barcelonajug.superherobattlearena.domain.Match.class);
                verify(matchRepository, times(2)).save(matchCaptor.capture());
                List<org.barcelonajug.superherobattlearena.domain.Match> newMatches = matchCaptor.getAllValues();
        ...
        void createMatch_shouldSaveNewMatch() {
                ...
                verify(matchRepository).save(any(org.barcelonajug.superherobattlearena.domain.Match.class));
        }
        ...
        void runMatch_shouldExecuteSimulationAndSaveResult() {
                ...
                org.barcelonajug.superherobattlearena.domain.Round round = new org.barcelonajug.superherobattlearena.domain.Round();
                round.setSeed(12345L);
                round.setSpecJson(
                                new org.barcelonajug.superherobattlearena.domain.json.RoundSpec(
                                                "Test", 1, 100, Map.of(), Map.of(), List.of(), Map.of(), "Arena"));
                when(roundRepository.findBySessionIdAndRoundNo(sessionId, roundNo))
                                .thenReturn(Optional.of(round));

                org.barcelonajug.superherobattlearena.domain.SimulationResult simResult = new org.barcelonajug.superherobattlearena.domain.SimulationResult(
                                teamA, 10,
                                List.of(mock(org.barcelonajug.superherobattlearena.domain.json.MatchEvent.class)));
                when(battleEngineUseCase.simulate(any(), any(), any(), anyLong(), any(), any(),
                                any()))
                ...
                when(fatigueUseCase.applyFatigue(any(UUID.class), anyList(), anyInt())).thenReturn(List.of(mockHero));
                ...
                assertThat(round.getStatus())
                                .isEqualTo(org.barcelonajug.superherobattlearena.domain.RoundStatus.CLOSED);
        }
        ...
        void runMatch_shouldHandleDraw() {
                ...
                org.barcelonajug.superherobattlearena.domain.Round round = new org.barcelonajug.superherobattlearena.domain.Round();
                round.setSpecJson(new org.barcelonajug.superherobattlearena.domain.json.RoundSpec("Test", 1, 100,
                                Map.of(), Map.of(), List.of(), Map.of(), "Arena"));
                when(roundRepository.findBySessionIdAndRoundNo(sessionId, roundNo)).thenReturn(Optional.of(round));
        ...
        void runMatch_shouldNotCloseRound_whenMatchesStillPending() {
                ...
                // Then
                assertThat(round.getStatus()).isEqualTo(org.barcelonajug.superherobattlearena.domain.RoundStatus.OPEN);
        }
        ...
        void getBattleTeam_shouldDelegateToBuildBattleTeam() {
                ...
                List<org.barcelonajug.superherobattlearena.domain.Hero> result = matchUseCase.getBattleTeam(teamId, sub,
                                1);
