...
class MatchUseCaseTest {
  ...
  void runMatch_shouldExecuteSimulationAndSaveResult() {
    ...
    org.barcelonajug.superherobattlearena.domain.Round round =
        new org.barcelonajug.superherobattlearena.domain.Round();
    ...
    org.barcelonajug.superherobattlearena.domain.SimulationResult simResult =
        new org.barcelonajug.superherobattlearena.domain.SimulationResult(
            teamA,
            10,
  ...
  void runMatch_shouldHandleDraw() {
    ...
    org.barcelonajug.superherobattlearena.domain.SimulationResult simResult =
        new org.barcelonajug.superherobattlearena.domain.SimulationResult(null, 10, List.of());
    when(battleEngineUseCase.simulate(any(), any(), any(), anyLong(), any(), any(), any()))
        .thenReturn(simResult);
  ...
  void runMatch_shouldNotCloseRound_whenMatchesStillPending() {
    ...
    org.barcelonajug.superherobattlearena.domain.SimulationResult simResult =
        new org.barcelonajug.superherobattlearena.domain.SimulationResult(teamA, 10, List.of());
    when(battleEngineUseCase.simulate(any(), any(), any(), anyLong(), any(), any(), any()))
        .thenReturn(simResult);
    ...
    // Then
    assertThat(round.getStatus())
        .isEqualTo(org.barcelonajug.superherobattlearena.domain.RoundStatus.OPEN);
  }
